<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSingleMenu.Master" AutoEventWireup="true" CodeBehind="inventory-unlock.aspx.cs" Inherits="WKS.DMS.WEB.Forms.inventory_unlock" %>
                    ...
                    <telerik:RadAjaxPanel ID="RadAjaxPanel1" ClientEvents-OnRequestStart="onRequestStart" runat="server" CssClass="grid_wrapper">
                        ...
                        <div>
                            <table>
                                <tr>
                                    <td></td>
                                    <td>Mở chốt tồn kho cho Nhà phân phối</td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
