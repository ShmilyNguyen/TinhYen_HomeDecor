...
{
    public partial class saleout_edit_2 : System.Web.UI.Page
    {
        public string _id = "";
            ...
            try 
            {
                using (SqlConnection conn = new SqlConnection(clsCommon.strCon))
                {
                    ...
                    if (!string.IsNullOrEmpty(id))
                    {
                        ...
                        Session["item_price"] = cbxHangHoa.SelectedItem.Attributes["item_price"].ToString();
        ...
        public void UpdateTrackingCustomerDebt()
        {
            try
            {
                ...
                if (data.Rows.Count > 0)
                {
                    ...
                    sQuery = @"delete from TrackingCustomerDebt where reference_id = {0} and order_no > 0";
        ...
        public void UpdateThanhTien()
        {
            ...
            try
            {
                ...
                {
                    sQuery = @"[usp_saleout_gettotalvalues_GT]";
                }
        ...
        protected void cbxKhachHang_SelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
        {
            ...
            {
                int ngaygiaodich = clsCommon.ConvertDateToNumber(rdpNgayGiaoDich.SelectedDate.Value);
                if( this.cbxKhachHang.SelectedItem.Attributes["isVAT"].Equals("") || this.cbxKhachHang.SelectedItem.Attributes["isOntop"].Equals("") )
                {
                    _is_vat = true;
                    _is_ontop = true;
        ...
        protected void btnInDonHang_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string _url = "PrintPreview.aspx?p0={0}&&p1={1}&&p2={2}&&p3={3}&&p4={4}&&p5={5}";
                _url = string.Format(_url, "saleout", hdf_SaleOut_ID.Value, _totalChietKhau, _totalGTCKDH, _totalPhaiThu, distID);
