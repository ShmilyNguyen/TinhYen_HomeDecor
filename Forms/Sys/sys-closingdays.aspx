<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSingleMenu.Master" AutoEventWireup="true" CodeBehind="sys-closingdays.aspx.cs" Inherits="WKS.DMS.WEB.Forms.Sys.sys_closingdays" %>
                    ...
                    <telerik:RadAjaxPanel ID="RadAjaxPanel1" ClientEvents-OnRequestStart="onRequestStart" runat="server" CssClass="grid_wrapper">
                        ...
                        <div>
                            <table>
                                <tr>
                                    <td></td>
                                    <td>Ngày Mở chốt tồn kho cho User</td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                    <td>
                                        &nbsp;</td>
                                    <td>
                                        <asp:DropDownList ID="ddlNgay" runat="server" Width="200px">
                        ...
                        <telerik:RadGrid ID="RadGrid1" runat="server" PagerStyle-PageButtonCount="5"
                            ...
                            <MasterTableView
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn HeaderText="Ngày"
                                        UniqueName="employee_name" FilterControlAltText="Filter item_code column"
