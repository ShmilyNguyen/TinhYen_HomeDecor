<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="promo-row-edit-chietkhau.ascx.cs" Inherits="WKS.DMS.WEB.Forms.promo_row_edit_chietkhau" %>
...
<table>
    ...
    <tr>
        <td>Giá trị / Số lượng</td>
        <td>
                                        <telerik:RadComboBox ID="cbxPromoType" runat="server" DataTextField="item_name" DataValueField="item_id" DropDownAutoWidth="Enabled" Filter="Contains" Width="200px">
                                            <Items>
    ...
    <tr>
        <td>Số lượng / Giá trị tham gia</td>
        <td>
                    <asp:TextBox ID="txtVol" runat="server" TextMode="Number" Width="200px">0</asp:TextBox>
        </td>
        <td>
                    &nbsp;</td>
    </tr>
    <tr>
        <td>Chiết khấu</td>
        <td>
                    <asp:TextBox ID="txtDiscount" runat="server" TextMode="Number" Width="200px">0</asp:TextBox>
        &nbsp;(%)</td>
        <td>
                    &nbsp;</td>
    </tr>
