...
{
    public partial class saleout_edit_mt : System.Web.UI.Page
    {
        public string _id = "";
        ...
        public string _price_group_id = "0";
        public string _customer_type_id = "0";

        public static bool _is_vat = true;
        public static bool _is_ontop = true;
        ...
        public void Reload_XuatKM()
       {
        ...
        public void Load_Item_List()
        {
            ...
            string storeProc = "[sp_HangHoa_List_v3]";
            using (SqlConnection conn = new SqlConnection(clsCommon.strCon))
            {
                SqlCommand cmd = new SqlCommand(storeProc, conn);
                cmd.CommandType = CommandType.StoredProcedure;

                cmd.Parameters.AddWithValue("@store_id", cbxStore.SelectedValue.Trim());
                ...
                cmd.Parameters.AddWithValue("@price_group_id", cbxBoGia.SelectedValue.Trim());
                cmd.Parameters.AddWithValue("@is_vat", _is_vat);
        ...
        public void Disable_Controls(bool is_readonly, bool is_confirmed, bool is_locked, bool is_returned, bool is_returned_order)
        {
            try
            {
                ...
                {
                    //btnReturnOrder.Enabled = false;
                    //Sua tam thoi cho NPP tra don hang
                    //btnReturnOrder.Enabled = true;
                }
            }
            catch (Exception ex)
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(clsCommon.strCon))
                {
                    ...
                    if (!string.IsNullOrEmpty(id))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@price_group_id", _price_group_id);
        ...
        protected void btnAddRow_Click(object sender, EventArgs e)
        {
            ...
            string storeProc = "[usp_Insertsaleout_detail_mt]";
            int result = 0;
            try
            {
                using (SqlConnection conn = new SqlConnection(clsCommon.strCon))
                {
                    ...
                    if (!string.IsNullOrEmpty(id))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@tax_rate", cbxHangHoa.SelectedItem.Attributes["giaban_vat"].ToString());
        ...
        public bool Check_Valid_LockDate()
        {
            try
            {
                ...
                string flag2 = "";
                string flag3 = "";
                string store_id = cbxStore.SelectedValue;
                string storeProc = "[sp_sys_config_check_lockdate_saleout]";
                string storeProcExtra = "[sp_sys_config_check_lockdate_saleout_extra]";
                using (SqlConnection conn = new SqlConnection(clsCommon.strCon))
                {
                    SqlCommand cmd1 = new SqlCommand(storeProc, conn);
                    SqlCommand cmd3 = new SqlCommand(storeProcExtra, conn);
                    ...
                    cmd3.Parameters.AddWithValue("@trans_date_gmt", rdpNgayGiaoDich.DbSelectedDate);
                    cmd3.Parameters.AddWithValue("@store_id", store_id);
                ...
                //Kiem tra ngay cho phep xuat kho va da chot kho hay chua
                if (bool.Parse(flag1) && bool.Parse(flag2))
                {
                    return true;
                }
        ...
        public void UpdateTrackingCustomerDebt()
        {
            try
            {
                //Kiem tra KH da co cong no hay chua
                ...
                sQuery = string.Format(sQuery, cbxStore.SelectedValue, cbxKhachHang.SelectedValue, hdf_SaleOut_ID.Value);
                DataTable data = SqlHelper.ExecuteDataset(clsCommon.strCon, CommandType.Text, sQuery).Tables[0];

                if (data.Rows.Count > 0)
                {
                    //Da co cong no
                    string doc_id = data.Rows[0]["doc_id"].ToString();
                    sQuery = @"update TrackingCustomerDebt set total_amt = {0} where doc_id={1} and order_no = 0";
                    sQuery = string.Format(sQuery, txtGTThanhToan.Value, doc_id);
                    SqlHelper.ExecuteNonQuery(clsCommon.strCon, CommandType.Text, sQuery);
                ...
                else
                {
                    ...
                    using (SqlConnection conn = new SqlConnection(clsCommon.strCon))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@total_amt", txtGTThanhToan.Value);
                        cmd.Parameters.AddWithValue("@recieve_amt", 0);
                        cmd.Parameters.AddWithValue("@balance_amt", 0);
                        cmd.Parameters.AddWithValue("@release", 0);
                        cmd.Parameters.AddWithValue("@note", "Phát sinh công nợ");
                        cmd.Parameters.AddWithValue("@created_by", Session["userid"].ToString());

                        cmd.Parameters.AddWithValue("@order_no", 0);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //if ( ((DateTime)rdpNgayGiaoDich.DbSelectedDate).Month > 9)
            //{
            //    RadWindowManager1.RadAlert("Ngày xuất kho tháng 9 đã bị khóa !", 330, 180, "Thông báo", null, null);
            //    return;
            //}
        ...
        public void UpdateThanhTien()
        {
            ...
            try
            {
                ...
                foreach (DataRow r in data.Rows)
                {
                    ...
                    txtGTVAT.Text = r["GT_VAT"].ToString();

                  

                    txtGTThanhToan.Text = r["GTThanhToan_SauThue"].ToString();
                }
        ...
        protected void btnNext_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                btnSave_Click(null, null);
                Response.Redirect("saleout-edit-mt.aspx");
            }
            catch (Exception ex)
            {
            }
        ...
        public void TinhToanKM()
        {
            try
            {
                ...
                Libs.clsPromotion_OnTop.TinhToanKM_TangHang_Ontop(cbxStore.SelectedValue, hdf_SaleOut_ID.Value, cbxKhachHang.SelectedValue, clsCommon.ConvertDateToNumber(rdpNgayGiaoDich.SelectedDate.Value));
        ...
        //public void TinhChietKhauNhomKhachHang()
        //{
        //    try
        //    {
        //   OnTopDiscount = 5;
        ...
        public void GetBoGia(int trans_date_numb)
        {
            try
            {
                string sQuery = @"[sp_price_group_list_v3]";
                SqlParameter[] arrSQLParam = new SqlParameter[3];
                arrSQLParam[0] = new SqlParameter("@trans_date_numb", trans_date_numb);
                arrSQLParam[1] = new SqlParameter("@store_id", cbxStore.SelectedValue);
                arrSQLParam[2] = new SqlParameter("@customer_id", cbxKhachHang.SelectedValue);
        ...
        protected void cbxKhachHang_SelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
        {
            ...
            try
            {
                ...
                _is_vat = bool.Parse(this.cbxKhachHang.SelectedItem.Attributes["isVAT"]);
                _is_ontop = bool.Parse(this.cbxKhachHang.SelectedItem.Attributes["isOntop"]);

                GetBoGia(ngaygiaodich);
                Update_Header(false);
                Load_Item_List();
                RadAjaxPanel2.ResponseScripts.Add(String.Format("$find('{0}').ajaxRequest();", RadAjaxPanel1.ClientID));
        ...
        //protected void cbxRoute_SelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
        //{
        //    if (cbxRoute.SelectedValue == "0")
        //    {
        //        Bind_CustomerBy_Employee();
        //    }
        //    else
        //    {
        //        Bind_CustomerByRoute();
        //    }
        //}
        ...
        protected void btnInDonHang_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                _VAT = decimal.Parse(txtGTVAT.Text);

                String distID = Session["channel_dist_id"].ToString().Trim();
                string _url = "PrintPreview.aspx?p0={0}&&p1={1}&&p2={2}&&p3={3}&&p4={4}&&p5={5}&&p6={6}";
                _url = string.Format(_url, "saleout", hdf_SaleOut_ID.Value, _totalChietKhau, _totalGTCKDH, _totalPhaiThu, distID, _VAT);
        ...
        protected void cbxHangHoa_ItemDataBound(object sender, RadComboBoxItemEventArgs e)
        {
            try
            {
                ...
                e.Item.Attributes["giaban_vat"] = ((DataRowView)e.Item.DataItem)["giaban_vat"].ToString();
            }
            catch (Exception ex)
            {
                throw;
        ...
        protected void cbxKhachHang_ItemDataBound(object sender, RadComboBoxItemEventArgs e)
        {
            try
            {
                e.Item.Attributes["isVAT"] = ((DataRowView)e.Item.DataItem)["isVAT"].ToString();
                e.Item.Attributes["isOntop"] = ((DataRowView)e.Item.DataItem)["isOntop"].ToString();
                // get customer_channel_id 
        ...
        protected void cbxChinhSachGia_SelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
        {
            Load_Item_List();
        }
