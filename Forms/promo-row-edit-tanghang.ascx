<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="promo-row-edit-tanghang.ascx.cs" Inherits="WKS.DMS.WEB.Forms.promo_row_edit_tanghang" %>
...
<table>
    <tr>
        <td>Mã hàng hóa tham gia KM</td>
        <td>
                    <asp:TextBox ID="txtMaHangHoa" runat="server" Enabled="False" Width="400px"></asp:TextBox>
        </td>
        <td>
                    &nbsp;</td>
    </tr>
    <tr>
        <td>Hàng hóa tham gia KM</td>
        <td>
                    <asp:TextBox ID="txtTenHangHoa" runat="server" Enabled="False" Width="400px"></asp:TextBox>
        </td>
        <td>
                    <asp:HiddenField ID="hdf_row_id" runat="server" />
                    <asp:HiddenField ID="hdf_promo_id" runat="server" />
                    <asp:HiddenField ID="hdf_item_id_src" runat="server" />
                    <asp:HiddenField ID="hdf_item_id_des" runat="server" />
        </td>
    </tr>
    <tr>
        <td>Số lượng tham gia</td>
        <td>
                    <asp:TextBox ID="txtVol_Src" runat="server" TextMode="Number" Width="200px">0</asp:TextBox>
        </td>
        <td>
                    &nbsp;</td>
    </tr>
    <tr>
        <td>Hàng hóa được tặng</td>
        <td>
                    <telerik:RadComboBox ID="cbxHangHoa_Des" runat="server" 
                       DataTextField="item_name" 
                        DataValueField="item_id" DropDownAutoWidth="Enabled" Filter="Contains" 
    ...
    <tr>
        <td>Số lượng tặng KM</td>
        <td>
                    <asp:TextBox ID="txtVol_Des" runat="server" TextMode="Number" Width="200px">0</asp:TextBox>
        </td>
        <td>
                    &nbsp;</td>
    </tr>
    <tr>
        <td><strong>Bước nhảy 2</strong></td>
        <td>
                    &nbsp;</td>
        <td>
                    &nbsp;</td>
    ...
    <tr>
        <td>SL tham gia</td>
        <td>
                    <asp:TextBox ID="txtVol_Src2" runat="server" TextMode="Number" Width="200px">0</asp:TextBox>
        </td>
        <td>
                    &nbsp;</td>
    </tr>
    <tr>
        <td>Hàng hóa tặng</td>
        <td>
                    <telerik:RadComboBox ID="cbxHangHoa_Des2" runat="server" 
                       DataTextField="item_name" 
                        DataValueField="item_id" DropDownAutoWidth="Enabled" Filter="Contains" 
                        Width="400px" OpenDropDownOnFocus="True">
                    </telerik:RadComboBox>
    ...
    <tr>
        <td>SL tặng</td>
        <td>
                    <asp:TextBox ID="txtVol_Des2" runat="server" TextMode="Number" Width="200px">0</asp:TextBox>
        </td>
        <td>
                    &nbsp;</td>
    </tr>
    <tr>
        <td><strong>Bước nhảy 3</strong></td>
        <td>
                    &nbsp;</td>
        <td>
                    &nbsp;</td>
    ...
    <tr>
        <td>SL tham gia</td>
        <td>
                    <asp:TextBox ID="txtVol_Src3" runat="server" TextMode="Number" Width="200px">0</asp:TextBox>
        </td>
        <td>
                    &nbsp;</td>
    </tr>
    <tr>
        <td>Hàng hóa tặng</td>
        <td>
                    <telerik:RadComboBox ID="cbxHangHoa_Des3" runat="server" 
                       DataTextField="item_name" 
                        DataValueField="item_id" DropDownAutoWidth="Enabled" Filter="Contains" 
                        Width="400px" OpenDropDownOnFocus="True">
                    </telerik:RadComboBox>
    ...
    <tr>
        <td>SL tặng</td>
        <td>
                    <asp:TextBox ID="txtVol_Des3" runat="server" TextMode="Number" Width="200px">0</asp:TextBox>
        </td>
        <td>
                    &nbsp;</td>
    </tr>
    <tr>
        <td><strong>Bước nhảy 4</strong></td>
        <td>
                    &nbsp;</td>
        <td>
                    &nbsp;</td>
    ...
    <tr>
        <td>SL tham gia</td>
        <td>
                    <asp:TextBox ID="txtVol_Src4" runat="server" TextMode="Number" Width="200px">0</asp:TextBox>
        </td>
        <td>
                    &nbsp;</td>
    </tr>
    <tr>
        <td>Hàng hóa tặng</td>
        <td>
                    <telerik:RadComboBox ID="cbxHangHoa_Des4" runat="server" 
                       DataTextField="item_name" 
                        DataValueField="item_id" DropDownAutoWidth="Enabled" Filter="Contains" 
                        Width="400px" OpenDropDownOnFocus="True">
                    </telerik:RadComboBox>
    ...
    <tr>
        <td>SL tặng</td>
        <td>
                    <asp:TextBox ID="txtVol_Des4" runat="server" TextMode="Number" Width="200px">0</asp:TextBox>
        </td>
        <td>
                    &nbsp;</td>
    </tr>
