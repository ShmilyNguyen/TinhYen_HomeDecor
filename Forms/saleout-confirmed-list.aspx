<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSingleMenu.Master" AutoEventWireup="true" CodeBehind="saleout-confirmed-list.aspx.cs" Inherits="WKS.DMS.WEB.Forms.saleout_confirmed_list" %>
    ...
    <div>
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" ClientEvents-OnRequestStart="onRequestStart" runat="server" CssClass="grid_wrapper">
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" PagerStyle-PageButtonCount="5"
                ...
                Height="800px" ResolvedRenderMode="Classic" Skin="Office2010Blue" AutoGenerateColumns="False" AllowFilteringByColumn="True">
                ...
                <MasterTableView TableLayout="Fixed"
                    ...
                    <Columns>
                        ...
                        <telerik:GridButtonColumn CommandName="View" Text="Xem" UniqueName="ViewColumn" HeaderText="Edit" FilterControlAltText="Filter ViewColumn column">
