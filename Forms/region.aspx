<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSingleMenu.Master" AutoEventWireup="true" CodeBehind="region.aspx.cs" Inherits="WKS.DMS.WEB.Forms.region" %>
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" ClientEvents-OnRequestStart="onRequestStart" runat="server" CssClass="grid_wrapper">
        <telerik:RadGrid ID="RadGrid1" runat="server" PagerStyle-PageButtonCount="5"
            ...
            <MasterTableView AutoGenerateColumns="False"
                ...
                DataKeyNames="region_id" CommandItemDisplay="Top"
                ...
                <Columns>
                    <telerik:GridBoundColumn HeaderText="ID"
                        UniqueName="id" FilterControlAltText="Filter item_id column" DataField="region_id">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="region_code" FilterControlAltText="Filter item_code column" HeaderText="Code" UniqueName="code">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="region_name" FilterControlAltText="Filter item_name column" HeaderText="Name" SortExpression="Name" UniqueName="name">
                 ...
                 <EditFormSettings UserControlName="region-edit.ascx" EditFormType="WebUserControl">
