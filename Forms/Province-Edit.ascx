<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Province-Edit.ascx.cs" Inherits="WKS.DMS.WEB.Forms.Province_Edit" %>
<table>
    <tr>
        <td>ID</td>
        <td>
            <asp:TextBox ID="txtID" runat="server" Width="400px" BackColor="#FFCC66"></asp:TextBox></td>
    </tr>
    <tr>
        <td>Code</td>
        <td>
