<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSingleMenu.Master" AutoEventWireup="true" CodeBehind="area.aspx.cs" Inherits="WKS.DMS.WEB.Forms.area" %>
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" ClientEvents-OnRequestStart="onRequestStart" runat="server" CssClass="grid_wrapper">
        <telerik:RadGrid ID="RadGrid1" runat="server" PagerStyle-PageButtonCount="5"
            ...
            <MasterTableView AutoGenerateColumns="False"
                ...
                DataKeyNames="area_id" CommandItemDisplay="Top"
                ...
                <Columns>
                    <telerik:GridBoundColumn HeaderText="ID"
                        UniqueName="id" FilterControlAltText="Filter item_id column" DataField="area_id">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="area_code" FilterControlAltText="Filter item_code column" HeaderText="Code" UniqueName="code">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="area_name" FilterControlAltText="Filter item_name column" HeaderText="Name" SortExpression="Name" UniqueName="name">
                 ...
                 <EditFormSettings UserControlName="area-edit.ascx" EditFormType="WebUserControl">
