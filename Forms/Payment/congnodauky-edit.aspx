<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSingleMenu.Master" AutoEventWireup="true" CodeBehind="congnodauky-edit.aspx.cs" Inherits="WKS.DMS.WEB.Forms.Payment.congnodauky_edit" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel2" ClientEvents-OnRequestStart="onRequestStart"
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadComboBox ID="cbxPaymentType" runat="server" AutoPostBack="True" DataTextField="payment_type_name" DataValueField="payment_type_id" DropDownAutoWidth="Enabled" Filter="Contains" OnSelectedIndexChanged="cbxPaymentType_SelectedIndexChanged" OpenDropDownOnFocus="True" Width="200px" Visible="false">
                            <Items>
