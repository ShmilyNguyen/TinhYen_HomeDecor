<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSingleMenu.Master" AutoEventWireup="true" CodeBehind="saleout-edit-mt.aspx.cs" Inherits="WKS.DMS.WEB.Forms.saleout_edit_mt" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel2" ClientEvents-OnRequestStart="onRequestStart"
            ...
            <table style="font-size:12px;font-family:Tahoma">
                <tr>
                    ...
                    <td   style="color:#fff"  nowrap>Ngày</td>
                    <td >
                ...
                <tr>
                    ...
                    <td   style="color:#fff" nowrap>Nhân viên</td>
                    <td>
                    ...
                    <td colspan="3">
                        ...
                        <telerik:RadComboBox ID="cbxKhachHang" runat="server" OnClientFocus="OnClientFocusHandler"
            ...
            HighlightTemplatedItems="true"  DropDownCssClass="exampleRadComboBox" AutoPostBack="True" OnItemDataBound="cbxKhachHang_ItemDataBound" OnSelectedIndexChanged="cbxKhachHang_SelectedIndexChanged"  >


                                <HeaderTemplate>
                                            <ul>
                                                <li class="col3">Khách hàng</li>
                                                <li class="col2" style="display:none">VAT</li>
                                                <li class="col2" style="display:none">Ontop</li>
                                        ...
                                        <ItemTemplate>
                                            <ul>
                                                <li class="col3">
                                                    <%# DataBinder.Eval(Container.DataItem, "customer_name") %></li>
                                                
                                                <li class="col2" style="display:none">
                                                    <%# DataBinder.Eval(Container.DataItem, "isVAT") %></li>
                                                <li class="col2" style="display:none">
                                                    <%# DataBinder.Eval(Container.DataItem, "isOntop") %></li>
                ...
                <tr>
                    <td nowrap style="color:#fff">Ghi chú</td>
                ...
                <tr>
                    <td   style="color:#fff" nowrap>
                        &nbsp;</td>
                    <td class="auto-style1">
                        <telerik:RadComboBox ID="cbxBoGia" runat="server" AutoPostBack="True" DataTextField="price_group_code" DataValueField="price_group_id" DropDownAutoWidth="Enabled" Filter="Contains" OnClientFocus="OnClientFocusHandler" OnSelectedIndexChanged="cbxBoGia_SelectedIndexChanged" OpenDropDownOnFocus="True" Visible="false"  Width="200px">
                        </telerik:RadComboBox>
                        <telerik:RadComboBox ID="cbxChinhSachGia" runat="server" AutoPostBack="True" DataTextField="item_price_code" DataValueField="item_price_policy_id" DropDownAutoWidth="Enabled" Filter="Contains" OnClientFocus="OnClientFocusHandler" OnSelectedIndexChanged="cbxChinhSachGia_SelectedIndexChanged" OpenDropDownOnFocus="True" Visible="false" Width="200px">
                        </telerik:RadComboBox>
                    </td>
                                ...
                                <HeaderTemplate>
                                        ...
                                        <ItemTemplate>
                                            <ul>
                                                ...
                                                <li class="col2" style="display:none">
                                                    <%# DataBinder.Eval(Container.DataItem, "giaban_vat") %></li>
...
&nbsp;</td>
                ...
                <MasterTableView TableLayout="Fixed" DataKeyNames="row_id" CommandItemDisplay="Top"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="qty" FilterControlAltText="Filter category_id1 column"
                            UniqueName="qty" HeaderText="SL" Aggregate="Sum" >
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn FilterControlAltText="Filter discount column" HeaderText="CK KM(%)"
                            UniqueName="discount" DataField="discount">
                        </telerik:GridBoundColumn>

                        <telerik:GridBoundColumn FilterControlAltText="Filter ontop_row_discount column" HeaderText="CK mặc định(%)"
                            UniqueName="ontop_row_discount" DataField="ontop_row_discount">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn DataField="GTChietKhauDongHang" FilterControlAltText="Filter total_discount column" Display="false"
                            HeaderText="GT CK" UniqueName="total_discount" Aggregate="Sum" DataFormatString="{0:###,###.##}">
                        </telerik:GridBoundColumn>

                        
                        <telerik:GridBoundColumn FilterControlAltText="Filter tax_rate column" HeaderText="VAT(%)"
                            UniqueName="tax_rate" DataField="tax_rate">
                        </telerik:GridBoundColumn>


                         <telerik:GridBoundColumn DataField="ThanhTien" FilterControlAltText="Filter ThanhTien column"
                            UniqueName="ThanhTien" HeaderText="Thành tiền" Aggregate="Sum" DataFormatString="{0:###,###.##}">
                        </telerik:GridBoundColumn>


                         <telerik:GridBoundColumn DataField="GT_VAT" FilterControlAltText="Filter GT_VAT column"
                            UniqueName="GT_VAT" HeaderText="GT VAT" Aggregate="Sum" DataFormatString="{0:###,###.##}" Display="true">
                        </telerik:GridBoundColumn>


                        <telerik:GridBoundColumn DataField="ThanhTien_SauThue" FilterControlAltText="Filter ThanhTien_SauThue column"
                            UniqueName="ThanhTien_SauThue" HeaderText="Thanh toán" Aggregate="Sum" DataFormatString="{0:###,###.##}">
                        </telerik:GridBoundColumn>
                ...
                <MasterTableView TableLayout="Fixed" DataKeyNames="row_id" CommandItemDisplay="Top"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn FilterControlAltText="Filter discount column" HeaderText="CK(%)"
                            UniqueName="discount" DataField="discount" Display="false">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn Display="False" FilterControlAltText="Filter promo_id column"
                            HeaderText="promo_id" UniqueName="promo_id">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn DataField="GTChietKhauDongHang" FilterControlAltText="Filter total_discount column"
                            HeaderText="GT CK" UniqueName="total_discount" Display="false">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="GTBan" FilterControlAltText="Filter category_id2 column"
                            UniqueName="total" HeaderText="Thành tiền" Aggregate="Sum" DataFormatString="{0:###,###.##}" Display="false">
                        </telerik:GridBoundColumn>
            ...
            <div>
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                           <telerik:RadNumericTextBox ID="txtGTVAT" runat="server" Enabled="False">
                            </telerik:RadNumericTextBox>
    ...
    <div>
        ...
        &nbsp;&nbsp;<asp:Button ID="btnInPhieuGiaoHang" runat="server" Text="In Phiếu giao" OnClick="btnInPhieuGiaoHang_Click" Width="120px" OnClientClick="var originalTarget = document.forms[0].target; document.forms[0].target = '_blank'; setTimeout(function () { document.forms[0].target = originalTarget; }, 3000);"/>
        &nbsp;
