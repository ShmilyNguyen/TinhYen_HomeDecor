<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="saleout-row-edit.ascx.cs" Inherits="WKS.DMS.WEB.Forms.saleout_row_edit" %>
<style type="text/css">
...
<table>
    <tr>
        <td>RowID</td>
        <td>
            <asp:TextBox ID="txtRowID" runat="server" Width="400px" BackColor="#FFCC66"></asp:TextBox></td>
    </tr>
    <tr>
        <td>Item ID</td>
        <td>
            <asp:TextBox ID="txtItemID" runat="server" Width="400px" BackColor="#FFCC66"></asp:TextBox></td>
    </tr>
    <tr>
        <td>Code</td>
        <td>
    ...
    <tr>
        <td class="auto-style4">Loại xuất</td>
        <td class="auto-style4">
                    <telerik:RadComboBox ID="cbxLoaiXuat" runat="server" DropDownAutoWidth="Enabled" Filter="Contains" Width="100px">
                        <Items>
    ...
    <tr>
        <td>&nbsp;</td>
        <td>
                    <telerik:RadComboBox ID="cbxCTKM" runat="server" DataTextField="promo_name" DataValueField="promo_id" DropDownAutoWidth="Enabled" Filter="Contains" Width="400px" Visible="False">
                    </telerik:RadComboBox>
        </td>
    </tr>
    ...
    <tr>
        <td>&nbsp;</td>
        <td>
            <asp:TextBox ID="txtDiscount" runat="server" Visible="False"></asp:TextBox>
        </td>
    </tr>
