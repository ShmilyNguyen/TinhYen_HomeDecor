<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSingleMenu.Master" AutoEventWireup="true" CodeBehind="Category-List.aspx.cs" Inherits="WKS.DMS.WEB.Forms.Category_List" %>
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" ClientEvents-OnRequestStart="onRequestStart" runat="server" CssClass="grid_wrapper">
        <telerik:RadGrid ID="RadGrid1" runat="server" PagerStyle-PageButtonCount="5"
            ...
            <MasterTableView AutoGenerateColumns="False"
                ...
                DataKeyNames="item_category_id" CommandItemDisplay="Top"
                ...
                <Columns>
                    <telerik:GridBoundColumn HeaderText="ID"
                        UniqueName="id" FilterControlAltText="Filter item_id column" DataField="item_category_id">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="item_category_code" FilterControlAltText="Filter item_code column" HeaderText="Code" UniqueName="code">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="category_name" FilterControlAltText="Filter item_name column" HeaderText="Name" SortExpression="Name" UniqueName="name">
                        <HeaderStyle Width="150px" />
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="category_level" FilterControlAltText="Filter category_id1 column" UniqueName="level" HeaderText="Level">
                    </telerik:GridBoundColumn>
                 ...
                 <EditFormSettings UserControlName="Category-Edit.ascx" EditFormType="WebUserControl">
