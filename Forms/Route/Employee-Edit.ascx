<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Employee-Edit.ascx.cs" Inherits="WKS.DMS.WEB.Forms.Employee_Edit" %>
...
<table>
    ...
    <tr>
        <td>HR Code</td>
        <td>
            <asp:TextBox ID="txtHRCode" runat="server" Width="400px" BackColor="#FFCC66"></asp:TextBox></td>
    </tr>

    <tr>
        <td>Name</td>
        <td>
            <asp:TextBox ID="txtName" runat="server" Width="400px" BackColor="#FFCC66"></asp:TextBox></td>
    </tr>
    <tr>
        <td>Chức vụ</td>
        <td>
            <asp:DropDownList ID="ddlPosition" runat="server" Width="400px" DataTextField="region_name" DataValueField="region_id" Style="margin-bottom: 0px">
                ...
                <asp:ListItem>ADMIN-MEKONG</asp:ListItem>
                <asp:ListItem>ADMIN-MIENDONG</asp:ListItem>
                <asp:ListItem>ADMIN-MIENTRUNG</asp:ListItem>
                <asp:ListItem>ADMIN-MIENBAC</asp:ListItem>
                <asp:ListItem>ADMIN-REPORT</asp:ListItem>
    ...
    <tr>
        <td>Quản lý cấp trên</td>
        <td>

                        <telerik:RadComboBox ID="ddlParentID" runat="server"  DataTextField="employee_name" DataValueField="employee_id" DropDownAutoWidth="Enabled" Filter="Contains" OpenDropDownOnFocus="True" Width="400px">
                        </telerik:RadComboBox>
    ...
    <tr>
        <td>Nhà phân phối</td>
        <td>
                        <telerik:RadComboBox ID="ddlStore"  runat="server"
                            DataTextField="store_name" DataValueField="store_id" DropDownAutoWidth="Enabled"
                            Filter="Contains" Width="400px" OpenDropDownOnFocus="True" >
                        </telerik:RadComboBox>
                    </td>
    </tr>
    ...
    <tr>
        <td>Ngày sinh</td>
        <td>
            <telerik:RadDatePicker ID="rdpNgaySinh" runat="server" Culture="en-US">
    ...
    <tr>
        <td>UserName</td>
        <td>
            <asp:TextBox ID="txtUsername" runat="server" Width="200px" BackColor="#FFCC66"></asp:TextBox></td>
    </tr>
    ...
    <tr>
        <td>Group</td>
        <td>
            <telerik:RadComboBox ID="cbxGroup_name"  DataValueField="group_id" DataTextField="group_name" runat="server" ></telerik:RadComboBox>
        </td>
         <td>
    ...
    <tr>
        <td>Nhóm quyền</td>
        <td>
            <asp:DropDownList ID="ddlRole" runat="server" Width="400px" DataTextField="region_name" DataValueField="region_id" Style="margin-bottom: 0px">
                <asp:ListItem></asp:ListItem>
