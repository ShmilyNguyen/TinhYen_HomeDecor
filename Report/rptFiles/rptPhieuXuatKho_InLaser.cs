...
{
    public partial class rptPhieuXuatKho_InLaser : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public rptPhieuXuatKho_InLaser()
        {
            InitializeComponent();
        }

        public rptPhieuXuatKho_InLaser(decimal totalThanhTien,decimal totalChietKhau,decimal totalThanhTienSauCKRow, decimal totalGTCKDH,decimal totalPhaiThu,string SoTienBangChu)
        {
            InitializeComponent();
            ...
            xrGTCanThu.Text = String.Format("{0:#,##0}", totalPhaiThu);
