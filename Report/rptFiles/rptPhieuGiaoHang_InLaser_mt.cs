...
{
    public partial class rptPhieuGiaoHang_InLaser_mt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public rptPhieuGiaoHang_InLaser_mt()
        {
            InitializeComponent();
        }

        public rptPhieuGiaoHang_InLaser_mt(decimal totalThanhTien,decimal totalChietKhau,decimal totalThanhTienSauCKRow, decimal totalGTCKDH,decimal totalPhaiThu,string SoTienBangChu)
        {
            InitializeComponent();
