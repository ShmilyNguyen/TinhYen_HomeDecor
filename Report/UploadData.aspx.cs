    ...
    public partial class UploadData : System.Web.UI.Page
    {
        ...
        public void BulkCopyData(DataTable tb)
        {
            try
            {
                ...
                _reporttypename = ddlReportName.SelectedValue;

                if (_reporttypename == "chitieudoanhsokhachhang")
                {
                    BulkCopyData_ChiTieuDoanhSoKhachHang(tb);   
                }
            }
            catch (Exception ex)
            {
        ...
        public void BulkCopyData_ChiTieuDoanhSoKhachHang(DataTable tb)
        {
            try
            {
                if (tb == null)
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string strOutputFileName = _reporttypename + "_" + ddlThang.Text + "_" + ddlNam.Text + "(" + _storename + ")";
        ...
        public DataTable ExportTemplateData(string ReportTypeName)
        {
            try
            {
                ...
                _filename = ddlReportName.SelectedValue;
                _storename = cbxStore.Text;
                ...
                if (ReportTypeName == "chitieudoanhsokhachhang")
                {
