<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSingleMenu.Master" AutoEventWireup="true" CodeBehind="rpt-BaoCaoTongHopThuTien.aspx.cs" Inherits="WKS.DMS.WEB.Report.rpt_BaoCaoTongHopThuTien" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div>
        ...
        <dx:ASPxGridView ID="grvData" runat="server" AutoGenerateColumns="False" CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" CssPostfix="Office2010Blue" Width="100%" EnableTheming="True" Theme="Office2010Blue">
            <GroupSummary>
                <dx:ASPxSummaryItem FieldName="total_amount" SummaryType="Sum" />
            </GroupSummary>
            <Columns>
                ...
                <dx:GridViewDataDateColumn Caption="Ngày chứng từ" FieldName="doc_date" VisibleIndex="3">
                    <PropertiesDateEdit DisplayFormatString="" Spacing="0">
                    </PropertiesDateEdit>
                </dx:GridViewDataDateColumn>
                <dx:GridViewDataTextColumn Caption="Số chứng từ" FieldName="doc_code" VisibleIndex="4" UnboundType="Decimal">
                ...
                <dx:GridViewDataTextColumn Caption="Total" VisibleIndex="8" FieldName="total_amount" UnboundType="Decimal">
                    <PropertiesTextEdit DisplayFormatString="###,###.##" NullDisplayText="0">
                    </PropertiesTextEdit>
                </dx:GridViewDataTextColumn>

                <dx:GridViewDataTextColumn Caption="Loại chứng từ" FieldName="doc_type" VisibleIndex="5">
                </dx:GridViewDataTextColumn>
            </Columns>
