...
{
    public partial class rpt_CongNoQuaHan : System.Web.UI.Page
    {
        ...
        public void BindData()
        {
            try
            {
                ...
                try
                {
                    string storeProc = "[sp_rpt_CongNoQuaHan]";
                    using (SqlConnection conn = new SqlConnection(clsCommon.strCon))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@report_month", 0);
        ...
        protected void btnExportExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ASPxGridViewExporter.WriteXlsxToResponse("CongNoQuaHan-" + ddlThang.SelectedValue);
            }
            catch (Exception ex)
            {
