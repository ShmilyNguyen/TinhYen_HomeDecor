...
{
    public partial class rpt_BaoCaoDoanhSoTheoKhachHang : System.Web.UI.Page
    {
        ...
        public void BindData()
        {
            try
            {
                ...
                try
                {
                    string storeProc = "[sp_rpt_BaoCaoDoanhSoKhachHang]";
        ...
        protected void btnExportExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ASPxGridViewExporter.WriteXlsxToResponse("BaoCaoDoanhSoKhachHang");
            }
            catch (Exception ex)
            {
