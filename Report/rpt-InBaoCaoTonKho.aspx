<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSingleMenu.Master" AutoEventWireup="true" CodeBehind="rpt-InBaoCaoTonKho.aspx.cs" Inherits="WKS.DMS.WEB.Report.rpt_InBaoCaoTonKho" %>
             ...
             <td style="color:#fff" >
                ...
                <td>
                    ...
                    <asp:DropDownList ID="ddlReportType" runat="server">
                        <asp:ListItem Value="GIAVON">GIÁ VỐN</asp:ListItem>
                        <asp:ListItem Value="GIABAN">GIÁ BÁN</asp:ListItem>
                    </asp:DropDownList>
                </td>
            <td>
                <asp:Button ID="btnView" runat="server" Text="Xem báo cáo"
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <dx:ASPxDocumentViewer ID="ASPxDocumentViewer1" runat="server"
        Theme="Office2010Blue" ToolbarMode="Ribbon" ReportTypeName="WKS.DMS.WEB.Report.rptFiles.rptPhieuXuatKhoAIO">
