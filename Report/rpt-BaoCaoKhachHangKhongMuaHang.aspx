<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSingleMenu.Master" AutoEventWireup="true" CodeBehind="rpt-BaoCaoKhachHangKhongMuaHang.aspx.cs" Inherits="WKS.DMS.WEB.Report.rpt_BaoCaoKhachHangKhongMuaHang" %>
    ...
    <div>
        ...
        <dx:ASPxGridView ID="grvData" runat="server" AutoGenerateColumns="False" CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" CssPostfix="Office2010Blue" Width="100%" EnableTheming="True" Theme="Office2010Blue">
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn Caption="Mã khách hàng" FieldName="customer_code"  VisibleIndex="6" Width="250px">
                </dx:GridViewDataTextColumn>

                <dx:GridViewDataTextColumn Caption="Khách hàng" FieldName="customer_name"  VisibleIndex="7" Width="250px">
                </dx:GridViewDataTextColumn>

                <dx:GridViewDataTextColumn Caption="Địa chỉ" FieldName="address_full" VisibleIndex="8" UnboundType="Decimal">
                ...
                <dx:GridViewDataTextColumn Caption="Route" FieldName="route_id" VisibleIndex="2">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="Channel" FieldName="channel_name" VisibleIndex="3">
                </dx:GridViewDataTextColumn>
